...
export default function OralHero({
  ...
  subtitle =
    "AI-powered Toothlens scanning, 24/7 Dial Care teledentistry, and Dental Discount Network Dental Discount Network network discounts—all in one affordable plan.",
  bullets = [
