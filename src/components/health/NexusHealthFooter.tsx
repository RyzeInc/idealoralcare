        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "2.5rem", alignItems: "start" }}>
          ...
          <div>
            <Image
              ...
              width={145}
              height={70}
              style={{ objectFit: "contain", marginBottom: "0", height: "auto", width: "auto" }}
            />
          </div>
