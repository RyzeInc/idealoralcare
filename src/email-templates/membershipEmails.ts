        ...
        <div style="padding: 30px; background: #f9fafb; border-radius: 0 0 8px 8px;">
          ...
          <div style="background: white; border: 1px solid #e5e7eb; border-radius: 10px; padding: 24px; margin: 24px 0;">
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 13px; margin-bottom: 8px;">
              ...
              <tr style="border-bottom: 1px solid #f1f5f9;">
                ...
                <td style="padding: 6px 0;">${data.periodicCharge ?? '$14.99'}</td>
              </tr>
              <tr>
          ...
          <div style="background: #e3f2fd; padding: 15px; border-radius: 5px; margin: 18px 0;">
            <p style="margin: 0 0 6px 0; font-size: 13px; line-height: 1.6;">
              <strong>To add a family member to your plan</strong>, contact Ideal Health at <strong>(844) 679-9367</strong>.
            </p>
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
          ...
          <div style="padding: 30px; background: #f9fafb; border-radius: 0 0 8px 8px;">
            ...
            <p style="font-size: 11px; color: #9ca3af; margin: 8px 0 0;">
              You received this email because your sponsoring organization added you to the Ideal Oral
