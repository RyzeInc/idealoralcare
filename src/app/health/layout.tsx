...
export const metadata = {
  ...
  description: 'Ideal Health - Comprehensive oral health plan with Toothlens AI scanning, 24/7 teledentistry, and Dental Discount Network dental network access.',
  icons: {
