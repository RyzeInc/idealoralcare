...
// Nexus Health Oral Health Plan landing page
...
export default function OralHealthLanding() {
  return (
    <div className="health-landing">
      <Head>
        <title>Oral Health Plan | Nexus Health</title>
        <meta name="description" content="Nexus Health Oral Health Plan - AI-powered oral scanning with Toothlens, teledentistry consultations, discount offerings, and access to nationwide specialists." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>
      {/* Header */}
      <header className="site-header">
        <div className="site-header_container container container--wide">
          <a href="/health" className="site-header__logo">
            <Image src="/nexus-health-logo.png" alt="Nexus Health logo" width={44} height={44} />
          </a>
            ...
            <ul className="nav-list">
              <li className="nav-item nav-item--dropdown">
                ...
                <div className="dropdown-menu">
                  <p className="dropdown-description">Comprehensive solutions to improve your health.</p>
                  <ul className="dropdown-list">
                    <li><a href="/health/dental">Oral Health Plan</a></li>
                    <li><a href="/health/glp">Wellness GLP Plan</a></li>
                  </ul>
                </div>
              </li>
              <li className="nav-item nav-item--dropdown">
                ...
                <div className="dropdown-menu">
                  ...
                  <ul className="dropdown-list">
                    <li><a href="/organizations/dental">Oral Health Plans</a></li>
                    <li><a href="/organizations/medicaid">Medicaid / CHIP</a></li>
                    <li><a href="/organizations/brokers">Benefits Brokers</a></li>
                    <li><a href="/organizations/employers">Employers</a></li>
                    <li><a href="/organizations/dso">DSO</a></li>
                  </ul>
                </div>
              </li>
              <li className="nav-item nav-item--dropdown">
                ...
                <div className="dropdown-menu">
                  ...
                  <ul className="dropdown-list">
                    ...
                    <li><a href="/about/providers">For Providers</a></li>
              ...
              <li className="nav-item">
                <a href="/health/resources" className="nav-link">Resource Center</a>
              </li>
            </ul>
          </nav>
        </div>
          ...
          <div className="row">
            <div className="col-8">
              <div className="hero-home__heading">
                <div className="hero-home__subtitle">NEXUS ORAL HEALTH PLAN</div>
      ...
      {/* Why Nexus Oral Health Works Better */}
      <section className="benefits section bg--white">
        <div className="container">
          <h2>Why Nexus Oral Health Works Better</h2>
          <ul className="benefits__list">
            ...
            <li><strong>Always Available</strong>: 24/7 access to dentists and oral health coaches means you can address concerns anytime, not just during office hours.</li>
      ...
      <section className="our-use-case section bg--blue">
        <div className="container">
          ...
          <div className="our-use-case__content">
            <div className="our-use-case__image">
              <img src="/health-assets/d1-team_896x1352-opt2.jpg" alt="Getting started with Nexus Oral Health" />
            </div>
            <ol className="our-use-case__list">
              <li><strong>Enroll in the Oral Health Plan</strong> - Create your Nexus Health account and select the Oral Health Plan at enrollment.</li>
        ...
        <div className="container">
          ...
          <div className="faq__list">
            <div className="accordion">
              <h4>What is the Nexus Oral Health Plan?</h4>
              <div>The Nexus Oral Health Plan is a comprehensive oral care solution featuring advanced AI technology (Toothlens for oral health scanning), 24/7 teledentistry access with experienced specialists, and a nationwide network of providers with discounted rates. It's designed to make oral care accessible, affordable, and preventative.</div>
            </div>
            <div className="accordion">
              <h4>How does Toothlens AI scanning work?</h4>
              <div>Toothlens is advanced AI technology that analyzes photos of your teeth and gums. Simply take clear photos and our AI provides a detailed oral health report identifying potential issues, calculating your oral health score, and recommending next steps. It's a convenient way to track your health between in-person visits.</div>
            </div>
            <div className="accordion">
            ...
            <div className="accordion">
              ...
              <div>Nexus Health has partnerships with a nationwide network of licensed dentists. Plan members receive negotiated discount rates on procedures like cleanings, fillings, root canals, and more. You can search our network to find nearby dentists and see their discount rates before scheduling.</div>
            </div>
          </div>
        </div>
      </section>
