...
const COMPARE_PRODUCTS: CatalogProduct[] = [
  {
    ...
    slug: "dental-savings",
    name: "Oral Health Savings",
    category: "dental",
    description: "AI scanning + teledentistry + discounts",
    inclusions: ["AI Oral Scanning", "24/7 Teledentistry", "140,000+ Specialists", "20-60% Discounts", "Emergency Support", "No Waiting Period"],
  ...
  },
  {
    ...
    name: "Vision Care",
    category: "vision",
    description: "Eye exams + glasses + contacts discounts",
    inclusions: ["40-50% Off Exams", "20-60% Off Glasses", "Contact Discounts", "LASIK Savings", "Online Retailers", "Unlimited Use"],
    exclusions: ["Discounts only", "No claims processing"],
    eligibilityRules: { requiresVerification: false, disclosureText: "Discount program." },
    activationBehavior: "immediate",
  ...
  },
  {
    ...
    name: "Telehealth",
    category: "telehealth",
    description: "Unlimited virtual doctor visits",
    inclusions: ["Unlimited Visits", "24/7 Available", "Prescriptions", "Mental Health", "No Visit Fees", "Board-Certified MDs"],
    exclusions: ["Virtual only", "No controlled substances"],
...
const FEATURE_VALUES: Record<string, Record<string, string | boolean>> = {
  ...
  "telehealth-1": {
    activation: "Immediate",
    network: "Board-Certified MDs",
    support: "24/7 Virtual",
    discounts: "$0 Visits",
    waiting: "None",
    family: true,
  },
