...
const COMPARE_PRODUCTS: CatalogProduct[] = [
  {
    ...
    pricing: { monthlyCardCents: 1499, monthlyACHCents: 1499, annualCardCents: 16489, annualACHCents: 16489 },
    metadata: { icon: "Smile" },
    isVisible: true,
    isFeatured: true,
    order: 0,
  },
  {
    ...
    eligibilityRules: { requiresVerification: false, disclosureText: "Discount program." },
    activationBehavior: "immediate",
    pricing: { monthlyCardCents: 2499, monthlyACHCents: 2499, annualCardCents: 27489, annualACHCents: 27489 },
    metadata: { icon: "Users" },
    isVisible: true,
    isFeatured: true,
    order: 1,
