...
**Purpose:** A month-end routine tying together Billing, List-Bill Invoices, Revenue & Dispersal, and Commissions so finance has a consistent view of the month that just closed — and knows which disagreements are expected (documented gaps) vs. real problems.

**Who can do this:** Any admin (Owner or Editor).

**When you'd do this:** First few business days of each month, after the prior month has ended.
...
1. **Revenue & Dispersal — confirm the period closed.**
...
2. **Revenue & Dispersal — sanity-check the grand totals.**
...
6. **Vendor payables.**
   From Revenue & Dispersal's Dispersal Breakdown table, click **Payables** on the Toothlens and Careington/Partner Vendor rows for the closed period, export, and hand off to AP for vendor payment.
...
- You should end this checklist with: a closed Revenue & Dispersal period, every list-bill group invoiced, overdue balances flagged for follow-up, and vendor payable exports handed to AP — with a clear mental note of which cross-page discrepancies are expected vs. worth escalating.

## If something goes wrong

- **A group's Revenue & Dispersal total and List-Bill Invoice total genuinely can't be explained by the known rate-source gap** — that's worth escalating as a real bug rather than assuming it's the documented issue; check whether the group has a custom rate configured that one system honors and the other doesn't.
